...
2. Use query refinement/expansion tools when gaps are identified
3. If gaps remain, generate refined/expanded queries and continue searching
4. Only stop when all required information is covered with sufficient evidence
</query_processing_system>
